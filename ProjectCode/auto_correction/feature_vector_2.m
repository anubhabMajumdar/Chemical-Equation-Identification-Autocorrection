...
fv = [ratio, stat.Centroid, stat.Area, stat.Perimeter, stat.MajorAxisLength, stat.MinorAxisLength, stat.Orientation, h_proj_moment2, h_proj_moment3, v_proj_moment2, v_proj_moment3, h_proj, v_proj, h1, v1, hp1(1), vp1(1)];
%fv = [h_proj, v_proj];
end